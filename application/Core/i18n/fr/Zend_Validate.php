 ...
 * @subpackage Application_Core_Translate
 * @desc       Application Zend_Translate french translation file
 * @author     Jean-Baptiste MONIN   <jb.monin@cleo-consulting.fr>
 * @copyright  2005 - 2011 CLEO CONSULTING
 * @link       http://www.cleo-consulting.fr
 * @license    http://framework.zend.com/license/new-bsd     New BSD License
 * @version    Release: 1.0 (Stable 2011-02-15)
 */

/**
 * FR-Revision: 20110624
 */
return array (
    ...
    "'%value%' is no valid email address in the basic format local-part@hostname" => "'%value%' n'est pas un email valide au format email@domaine",
    ...
    "The two given tokens do not match" => "Les deux champs précédents ne sont pas identiques",
    ...
    "Value is required and can't be empty" => "Cette information est obligatoire",
    "'%value%' is not a valid URL." => "%value% n'est pas une URL valide au format http(s)://hote.domaine.ext",
);